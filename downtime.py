...
if movie == "y":
    top_time -= buffer_time
    schedule.append(TimeBlock("Buffer", top_time, buffer_time))
else:
    if sanction == "y":
        top_time -= sanction_time
        schedule.append(TimeBlock("Final Meal", top_time, sanction_time))
    else:
